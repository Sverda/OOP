...
const Passenger& Passenger::operator+=(const Passenger& mk)
{
	//base operator?
	price += mk.price;
...
const Passenger operator+(const Passenger& a, const Passenger& b)
{
	return Passenger(a.boot + b.boot, a.doors + b.doors, a.figure, a.price + b.price, a.engineType);
}